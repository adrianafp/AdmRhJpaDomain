...
/**
 * The persistent class for the fadicionesdescf database table.
 * 
 */
@Entity
@Table(name="fadicionesdescf")
public class Fadicionesdescf implements Serializable {
	private static final long serialVersionUID = 1L;

	private Long idFAdicionesDescF;
	...
	public Fadicionesdescf() {
	}

	@Id
	@GeneratedValue(strategy=GenerationType.IDENTITY)
	public Long getIdFAdicionesDescF() {
		return this.idFAdicionesDescF;
	}

	public void setIdFAdicionesDescF(Long idFAdicionesDescF) {
		this.idFAdicionesDescF = idFAdicionesDescF;
	}
