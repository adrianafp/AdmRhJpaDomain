...
public class FuncionarioSummary implements Serializable{
	...
	public FuncionarioSummary(){
		
	}
	
	public FuncionarioSummary(Short tarjeta, String nombre, boolean selected){
